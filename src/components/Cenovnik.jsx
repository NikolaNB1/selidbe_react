  ...
  return (
    <section id="cenovnik_section">
      ...
      <div className="about_text_inner">
        ...
        <p>
          Cena selidbe može da varira za istu veličinu stana što zavisi od
          količine selidbenih stvari, potrebe demontaže i montaže, prilaza
          objektu, spratnosti, postojanja teretnog lifta, broja potrebnih
          radnika. Takođe, da li je potrebna selidba u unutrašnjost Srbije i
          obrnuto, da li se selidba obavlja za ceo prostor ili samo deo
          prostora.
        </p>
        <hr
          style={{
